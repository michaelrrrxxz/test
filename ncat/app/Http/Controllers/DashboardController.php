...
use App\Models\{EnrolledStudent, Batch, Result,ActivityLog,Instructor,StudentAnswer};
    ...
    public function getExamYearData()
{
    ...
    public function index()
    {
        ...
        return view('Admin.Dashboard.index', compact(['batch','enrolled','countWithoutExam','countExam','ongoingExams']));
    }
