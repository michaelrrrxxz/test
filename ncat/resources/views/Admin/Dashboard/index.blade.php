...
<div class="row content-card">
    ...
    <div class="col-12 mb-4">
        ...
        <div class="row">
            ...
            @foreach ([['Batches', $batch, 'bg-danger', 'fas fa-layer-group', 'Batch'], 
                       ...
                       ['No Exam Students', $countWithoutExam, 'bg-warning', 'fas fa-user-times', 'No-Exam'],
                       ['Exam Students', $countExam, 'bg-info', 'fas fa-file-alt', 'Results']] as $widget)
    ...
    <div class="col-md-6">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title text-white">Students per Year</h3>
    ...
    <div class="col-md-6">
        <div class="card">
            <div class="card-header text-white">
                <h3 class="card-title">Exam Participation by Year</h3>
                <div class="card-tools">
                    <a href="{{route('EnrolledStudents')}}" type="button" class="btn btn-tool">
                        <i class="fas fa-arrow-right text-white"></i>
                    </a>
