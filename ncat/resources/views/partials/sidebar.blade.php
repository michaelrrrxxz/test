            ...
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                @if(Auth::check())
                    ...
                    @if(Auth::user()->role === 'administrator')
                        ...
                        <li class="nav-item">
                            <a href="{{ route('No-Exam') }}" class="nav-link {{ request()->is('No-Exam') ? 'active' : '' }}">
                        ...
                        <li class="nav-item {{ request()->is('EnrolledStudents', 'Students') ? 'menu-open' : '' }}">
                            <a href="#" class="nav-link {{ request()->is('EnrolledStudents', 'Students') ? 'active' : '' }}">
                        ...
                        <li class="nav-item {{ request()->is('Users', 'Instructors') ? 'menu-open' : '' }}">
                            <a href="#" class="nav-link {{ request()->is('Users', 'Instructors') ? 'active' : '' }}">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    ...
                                    {{-- <li class="nav-item">
                                        <a href="{{ route('Instructors') }}" class="nav-link {{ request()->is('Instructors') ? 'active' : '' }}">
                                            <i class="nav-icon fas fa-user"></i>
                                            <p>Instructors</p>
                                        </a>
                                    </li> --}}
