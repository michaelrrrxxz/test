...
<head>
   ...
   <script>document.addEventListener("DOMContentLoaded", () => {
    ...
    if (isMobileDevice()) {
        // Block the website for mobile users
        document.body.innerHTML = ` `;
        document.body.style.backgroundColor = "#f8d7da";
    } else {
        // Allow PC users to access the website
        toastr.success("PC detected. Access allowed.");
    }
});
</script>
   <style>
    ...
    <div class="card">
        <div class="card-body login-card-body">  
            ...
            <ul class="nav nav-tabs justify-content-center" id="loginTab" role="tablist">
                ...
                <li class="nav-item">
                    <a class="nav-link" id="accessKey-tab" data-toggle="tab" href="#accessKeyPane" role="tab" aria-controls="accessKeyPane" aria-selected="false">Exam</a>
                </li>
            </ul>  
            <!-- Tab content -->
     ...
     --}}
                <!-- Access Key Form Tab -->
                <div class="tab-pane fade show active" id="accessKeyPane" role="tabpanel" aria-labelledby="accessKey-tab">
