...

{
    ...
    public function show($student_id = null)
    {
        ...
        $name = EnrolledStudent::where('id_number',$studentId )
        ->pluck('name')
        ->first();
        $course = EnrolledStudent::where('id_number',$studentId )
        ->pluck('course')
        ->first();
    ...
    public function showInformationForm(Request $request)
    {
        ...
        return view('layouts.information', [
            ...
            'studentName' => $student->name,
             'schools' =>  $school,  // Assuming the 'name' column exists in the students table
        ]);
    }
